...
const [selectedCourseId, setSelectedCourseId] = useState("");
  ...
  const [newMaterial, setNewMaterial] = useState({ title: "", type: "", file: null });
  ...
  const handleAddMaterial = async () => {
    ...
    formData.append("course_id", selectedCourseId); // Replace or pass dynamically
    ...
    try {
      ...
      setNewMaterial({ title: "", type: "", file: null });
    } catch (error) {
